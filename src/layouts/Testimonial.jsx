  ...
  return (
    <section className='container pb-[265px] pt-[50px]'>
      <div className='relative'>
        ...
        <h4 className='capitalize text-center mx-auto text-[48px] font-[700] leading-[1] max-w-[500px] xl:text-[32px]'>
          What our users <br />
          say about us?
        </h4>
        <img
      ...
      <div className='grid grid-cols-12 gap-[20px] items-center lg:flex lg:flex-col'>
        ...
        <div className='col-span-5 flex flex-col grid-flow-row gap-[24px] mt-[125px] xl:mt-[80px] xl:col-span-6 lg:order-2 lg:py-0 lg:mt-0'>
          ...
          <img src='/testimony-avatar.png' alt='avatars' width={192} />
